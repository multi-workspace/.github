<p align="center">
  <picture>
    ...
    <img src="assets/hero-light.svg" alt="WanWeave" width="100%">
  </picture>
</p>
...
**Intent, observation and evidence are three different records.** What we meant to build,
what we actually have, and what we actually proved. Let one impersonate another and the
project starts lying to itself.

**Machines propose; people decide.** Automation drafts and plans. The moment something
irreversible happens, a human is in the loop, permission is single-use, and the receipt
